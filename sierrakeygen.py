...
# (c) Jembyte 2025 under MIT license
...
class SierraKeygen():
    def __init__(self,devicegeneration=None):
        self.keygen = SierraGenerator()

def main(args):
    version = "1.3"
    info = 'Sierra Wireless Generator ' + version + '\n(c) B. Kerler 2019-2021\n(c) Jembyte 2025'
    ...
    if (devicegeneration == "" or (openlock == "" and openmep == "" and opencnd == "")):
        print(info)
        print("------------------------------------------------------------\n")
        print("Usage: ./sierrakeygen [-l,-m,-c] [challenge] -d [devicegeneration]")
        print("Example: ./sierrakeygen.py -l BE96CBBEE0829BCA -d MDM9x30")
    ...
    kg = SierraKeygen(devicegeneration)
    if openlock != "":
